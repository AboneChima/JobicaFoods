  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <Link
          href="/admin"
          className="fixed bottom-6 right-6 bg-emerald-600 text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center text-2xl hover:bg-emerald-700 active:scale-95 transition"
        >
          +
        </Link>
        ...
        <div className="p-4">
          ...
          <div className="mt-4 flex gap-3 pb-2">
            <Link
              ...
              className="flex-1 bg-emerald-600 text-white py-3 rounded-xl text-center font-semibold active:bg-emerald-700 transition"
            >
              Edit Product
            </Link>
            <button
              onClick={onClose}
              className="flex-1 bg-gray-200 text-gray-700 py-3 rounded-xl text-center font-semibold active:bg-gray-300 transition"
            >
              Close
            </button>
          </div>
